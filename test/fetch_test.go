...
func TestFetchPriceFromUrl(t *testing.T) {
	t.Run("Test fetch price from planetasport url", func(t *testing.T) {
		planetaPriceTracker := price_tracker.GetPriceTracker("Adidas Soulstride", "https://planetasport.rs/patike-terrex-soulstride-r-rdy-m-ig8029.html")
	...
	t.Run("Test fetch price from sportvision url", func(t *testing.T) {
		sportVisionPriceTracker := price_tracker.GetPriceTracker("Adidas Soulstride", "https://www.sportvision.rs/patike/69947717-adidas-terrex-soulstride")
